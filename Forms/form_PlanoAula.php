<?php
	...
	echo"<table><tr>
		...
		<form action='form_CadastroPlanoAula.php' method='post'>
			<td><input type='submit' value='Cadastrar'/></td>
		</form>
		</tr></table>";

		  $query = "select * from Tb_Plano a inner join Tb_Usuario u on a.Cod_Usuario = u.Cod_Usuario inner join Tb_Disciplina d on a.Cod_Disciplina = d.Cod_Disciplina";
