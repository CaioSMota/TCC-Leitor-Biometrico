<?php
	...
	echo"<table><tr>
		...
		<form action='form_CadastroAula.php' method='post'>
			<td><input type='submit' value='Cadastrar'/></td>
		</form>
		</tr></table>";

		  $query = "select * from Tb_Aula a inner join Tb_Plano p on a.Cod_Plano = p.Cod_Plano inner join Tb_Disciplina d on p.Cod_Disciplina = d.Cod_Disciplina";
